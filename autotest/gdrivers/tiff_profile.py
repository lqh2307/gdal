...
def test_tiff_copy_options_colorimetric_data():
    ...
    tifftag_transferfunction = (
        list(range(1, 256 * 4, 4)),
        list(range(2, 256 * 4 + 1, 4)),
        list(range(3, 256 * 4 + 2, 4)),
    )
    ...
    options = [
        ...
        + cvtTuple2String(tifftag_transferfunction[1]),
...
def test_tiff_update_colorimetric():
    ...
    ds.SetMetadataItem(
        "SOURCE_PRIMARIES_RED", cvtTuple2String(source_primaries[0]), "COLOR_PROFILE"
    )
    ds.SetMetadataItem(
        "SOURCE_PRIMARIES_GREEN", cvtTuple2String(source_primaries[1]), "COLOR_PROFILE"
    )
    ds.SetMetadataItem(
        "SOURCE_PRIMARIES_BLUE", cvtTuple2String(source_primaries[2]), "COLOR_PROFILE"
    )
    ds.SetMetadataItem(
        "SOURCE_WHITEPOINT", cvtTuple2String(source_whitepoint), "COLOR_PROFILE"
    )
    ds.SetMetadataItem(
        "TIFFTAG_TRANSFERFUNCTION_RED",
        cvtTuple2String(tifftag_transferfunction[0]),
        "COLOR_PROFILE",
    )
    ds.SetMetadataItem(
        "TIFFTAG_TRANSFERFUNCTION_GREEN",
    ...
    ds.SetMetadataItem(
        ...
        cvtTuple2String(tifftag_transferfunction[2]),
        "COLOR_PROFILE",
    )
    md = ds.GetMetadata("COLOR_PROFILE")
    ds = None
